...
// .wrangler/tmp/bundle-0dap74/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-w0KBRr/functionsWorker-0.16786236454009362.mjs
...
async function onRequestPost2({ request, env }) {
  const incrementMetric = /* @__PURE__ */ __name2(async (keyPrefix) => {
    if (!env.WHICHAIPICK_KV)
      return;
    try {
      const dateKey = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
...
// .wrangler/tmp/bundle-0dap74/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0dap74/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.16786236454009362.js.map
