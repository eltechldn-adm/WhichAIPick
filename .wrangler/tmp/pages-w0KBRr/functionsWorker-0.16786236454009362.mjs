...
// ../.wrangler/tmp/bundle-Q1Uv1j/strip-cf-connecting-ip-header.js
...
// _lib/email.js
async function sendMail({ to, from, fromName, subject, text, html }) {
  const payload = {
    personalizations: [
      {
        to: [{ email: to }]
...
async function onRequestPost2({ request, env }) {
  const incrementMetric = /* @__PURE__ */ __name(async (keyPrefix) => {
    if (!env.WHICHAIPICK_KV)
      return;
    try {
      const dateKey = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
  ...
  try {
    ...
    if (env.WHICHAIPICK_KV) {
      ...
      try {
        ...
        if (summaryIndex.length > 2e3)
          summaryIndex = summaryIndex.slice(0, 2e3);
        await env.WHICHAIPICK_KV.put("submit:summary:index", JSON.stringify(summaryIndex));
        ...
        if (indexData.length > 2e3)
          indexData = indexData.slice(0, 2e3);
...
Admin Link: https://whichaipick.com/admin/submissions.html
        ...
        const htmlContent = `
                    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
                        <h2 style="color: #1a1a2e;">New Tool Submission: ${escapeHTML2(payload.tool_name)}</h2>
                        <p><strong>KV Key:</strong> <code>${submissionId}</code></p>
                        <p><strong>Timestamp:</strong> ${(/* @__PURE__ */ new Date()).toISOString()}</p>
                        <p><strong>Type:</strong> ${escapeHTML2(payload.submission_type)}</p>
                        <p><strong>Website:</strong> <a href="${escapeHTML2(payload.website_url)}">${escapeHTML2(payload.website_url)}</a></p>
                        <p><strong>Category:</strong> ${escapeHTML2(payload.primary_category)}</p>
                        <p><strong>Tags:</strong> ${escapeHTML2(payload.tags || "None")}</p>
                        <hr style="border-top:1px solid #ccc;">
                        <h3>Pricing & Features</h3>
                        <p><strong>Model:</strong> ${escapeHTML2(payload.pricing_model)} (Free Tier: ${payload.has_free_tier ? "Yes" : "No"})</p>
                        <p><strong>Notes:</strong> ${escapeHTML2(payload.pricing_notes || "None")}</p>
                        <hr style="border-top:1px solid #ccc;">
                        <h3>Description</h3>
                        <p>${escapeHTML2(payload.description).replace(/\n/g, "<br>")}</p>
                        <hr style="border-top:1px solid #ccc;">
                        <h3>Links & Assets</h3>
                        <p><strong>Logo URL:</strong> ${escapeHTML2(payload.logo_url || "N/A")}</p>
                        <p><strong>Demo URL:</strong> ${escapeHTML2(payload.demo_url || "N/A")}</p>
...
// ../.wrangler/tmp/pages-w0KBRr/functionsRoutes-0.7926388669094553.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-Q1Uv1j/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Q1Uv1j/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.16786236454009362.mjs.map
